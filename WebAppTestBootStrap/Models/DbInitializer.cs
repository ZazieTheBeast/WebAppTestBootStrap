        ...
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            ...
            if (!context.Pictures.Any())
            {
                ...
                (
                    ...
                    new Picture { Name = "Strawberry Moon in Cincinnati", ShortDescription = "Strawberry Moon in Cincinnati", LongDescription = "Strawberry Moon in Cincinnati", Category = Categories["Cityscapes"], ImageUrl = "/images/big/35847719836_a4eda13b05_k.jpg", IsPictureOfTheWeek = true, ImageThumbnailUrl = "/images/thumbs/35847719836_9bbde0568b_z.jpg" },
